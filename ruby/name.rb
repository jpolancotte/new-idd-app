...
CSV.open("csv/11_13_25_web_results.csv", "a") do |fl|
  CSV.foreach("csv/11_13_25_web.csv", headers: true, :encoding => 'windows-1251:utf-8', header_converters: :symbol, converters: :all) do |row|     
    numb=row[0]
    numb=numb.to_s
    first=row[1]
    last=row[2]
