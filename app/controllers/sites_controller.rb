class SitesController < ApplicationController
  ...
  private
    ...
    def site_params
      params.require(:site).permit(:name, :organization_id, :address, :city, :state, :zip, :county, :beds, :category, :service_type, :total_bed_count, :total_resident_count, :icf_idd, :license_number)
    end
end
